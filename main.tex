...
\[
h_t=\frac{\sum_{j<t}\mathds{1}[u_j=u_t, s_j=s_t]y_j}{\sum_{j<t}\mathds{1}[u_j=u_t, s_j=s_t]+\epsilon}.
\]
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.65\linewidth]{results_reframed_proficiency_5x/risk_coverage_overall.png}
